...
A frequent problem in classification appears when working with datasets that have an unequal amount of samples per class and are therefore called a \emph{class imbalanced} datasets [1]. %, where \emph{classes} describe the categories which the model has to classify.
