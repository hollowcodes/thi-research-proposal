...
def preprocess(nationalities: str="", raw_dataset_path: str=""):
    # load raw dataset
    ...
    dataset_path = "dataset/preprocessed-dataset"
...
preprocess(nationalities=["british", "american", "german", "spanish", "italian"], raw_dataset_path="dataset/raw-dataset/raw-name-nationalities.pickle")
