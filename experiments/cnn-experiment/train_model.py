...
class Run:
    def __init__(self, run_name: str="", model_file: str="", dataset_name: str="", classes: str="", epochs: int=10, lr: float=0.001, lr_decay: Tuple[float]=(100, 0.99), 
    ...
    def test(self, pre_true_positive_rates: list=None, print_examples: bool=True):
        ...
        _, accuracy, scores = self._validate(model, self.test_dataset, confusion_matrix=False, plot_scores=False)
