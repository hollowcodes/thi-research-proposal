...
data_batches = ["dataset/raw-dataset/data_batch_" + str(i) for i in range(1, 6)]  # + [("datasets/cifar-10/" + "test_batch")]
...
if __name__ == "__main__":
    ...
    np.save("dataset/preprocessed-dataset/train_dataset.npy", np.array(train_set))
    np.save("dataset/preprocessed-dataset/val_dataset.npy", np.array(val_set))
    np.save("dataset/preprocessed-dataset/test_dataset.npy", np.array(test_set))